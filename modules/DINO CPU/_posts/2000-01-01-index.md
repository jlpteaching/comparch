...
See the [GitHub Repository]({{ site.course.data.dino_cpu_link }}) for high-level details about the DINO CPU project and how to contribute.

You can find documentation in the [DINO CPU repository]({{ site.course.data.dino_cpu_link }}/blob/main/documentation/).

[Chisel notes]({{ site.course.data.dino_cpu_link }}/blob/main/documentation/chisel-notes/overview.md) goes through an introduction to Chisel and how to create hardware.

The [Chisel cheat sheet]({{ site.course.data.dino_cpu_link }}/blob/main/documentation/chisel-notes/overview.md) is particularly useful for the projects.

There's also a list of [common errors]({{ site.course.data.dino_cpu_link }}/blob/main/documentation/common-errors.md) that you may run into while working on the DINO CPU.

Finally, for debugging, the documentation on [Single stepping]({{ site.course.data.dino_cpu_link }}/blob/main/documentation/single-stepping.md) will be very useful.

## Assignments/Projects

### [Assignment 1: Getting started with Chisel]({{'modules/dino cpu/assignment1' | relative_url}}) DUE *{{ site.data.course.dino_1 }}*
...
### [Assignment 2: A single-cycle CPU design]({{'modules/dino cpu/assignment2' | relative_url}}) DUE *{{ site.data.course.dino_2 }}*
...
### [Assignment 3: A pipelined CPU design]({{'modules/dino cpu/assignment3' | relative_url}}) DUE *{{ site.data.course.dino_32 }}*
...
### [Assignment 4: TBD]({{'modules/dino cpu/assignment4' | relative_url}}) DUE *{{ site.data.course.dino_4 }}*

TBD

### [Assignment 5: Parallel architecture with gem5]({{'modules/gem5/assignment5' | relative_url}}) DUE *{{ site.data.course.dino_5 }}*
